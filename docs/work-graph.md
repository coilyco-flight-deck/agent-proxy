...
- [#77](https://forgejo.coilysiren.me/coilyco-flight-deck/agent-proxy/issues/77) enforces opt-in capture of every field in complete model request and response bodies at the Agent Proxy boundary.
