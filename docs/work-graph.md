...
- [#77](https://forgejo.coilysiren.me/coilyco-flight-deck/agent-proxy/issues/77) - landed - enforces opt-in capture of every field in complete model request and response bodies at the Agent Proxy boundary, with the restricted ser8 deployment and live SigNoz proof complete.
